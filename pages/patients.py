      ...
      <div class="modal-body">
        <form id="editPatientForm">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="editCondition" class="form-control" readonly>
          </div>
          <div class="mb-3">
            <label for="editSeverity" class="form-label">Severity</label>
            <input type="text" id="editSeverity" class="form-control" readonly>
          </div>
...
document.addEventListener('click', e => {
  if (e.target.closest('.edit-patient')) {
    ...
    document.getElementById('editLastVisit').value = patient.last_visit;
    document.getElementById('editCondition').value = patient.condition;
    document.getElementById('editSeverity').value = patient.severity;
